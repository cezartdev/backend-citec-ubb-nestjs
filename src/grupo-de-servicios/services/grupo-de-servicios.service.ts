...
import { ObtenerPorIdGrupoDeServiciosDto, RetornoGrupoDeServiciosDto } from '../dtos/grupo-de-servicios.dto';
...
export class GrupoDeServiciosService extends BaseServicesSimple {
    ...
    async obtenerPorId(clavePrimaria: ObtenerPorIdGrupoDeServiciosDto): Promise<GruposDeServicios> {
        const grupoRetorno = await GruposDeServicios.findByPk(clavePrimaria.nombre);
